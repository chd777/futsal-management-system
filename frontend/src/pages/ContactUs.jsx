    ...
    <div>
      ...
      <div className="two-col" style={{ marginTop: 0 }}>
        <div className="panel" style={{ padding: 16 }}>
          ...
          <p className="muted small" style={{ marginTop: 8 }}>📍 Kathmandu, Nepal</p>
        </div>
          ...
          <div style={{ display: "grid", gap: 14 }}>
            ...
            <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
              ...
              <div>
                ...
                <div className="muted small">futsalms6@gmail.com</div>
              </div>
            </div>
      ...
      {/* Bottom Row: Contact Form (left) + FAQ (right) */}
      <div className="two-col">
        <div className="panel" style={{ padding: 24 }}>
          ...
          {sent && (
            <div className="alert ok" style={{ marginBottom: 14 }}>
              ✅ Your message has been sent to our team! Check your email for confirmation.
            </div>
          )}
          {error && (
        ...
        <div className="panel" style={{ padding: 22 }}>
          ...
          <div style={{ display: "grid", gap: 12 }}>
            ...
            <div style={{ borderTop: "1px solid var(--border)", paddingTop: 12 }}>
              <div style={{ fontWeight: 600, fontSize: 13, marginBottom: 4 }}>Can I book multiple hours at once?</div>
              <div className="muted small">Yes! Select consecutive time slots and pay once for the total amount.</div>
            </div>
            <div style={{ borderTop: "1px solid var(--border)", paddingTop: 12 }}>
